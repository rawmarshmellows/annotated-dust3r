...
class PatchEmbed(nn.Module):
    ...
    def forward(self, x: torch.Tensor, **not_used) -> Tuple[torch.Tensor, torch.Tensor]:
        """
        ...
        """
        assert not_used == {}, f"Unexpected keyword arguments: {not_used}"
